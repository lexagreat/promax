         ...
         <div class="prodtabs__inner">
            <div class="prodtabs__control">
               <div class="prodtabs-tabs">
                  <div class="prodtabs-tabs__item" @click="setTab('trend')" :class="{ _active: url == 'trend' }">Тренд
                     2024</div>
                  <div class="prodtabs-tabs__item" @click="setTab('hit')" :class="{ _active: url == 'hit' }">
                     Хит
                     продаж</div>
                  <div class="prodtabs-tabs__item" @click="setTab('best')" :class="{ _active: url == 'best' }">
                     Лучшее предложение</div>
               </div>
               <NuxtLink to="catalog" class="prodtabs__btn _btn">Перейти в Каталог</NuxtLink>
            </div>
