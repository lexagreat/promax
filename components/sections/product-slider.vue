<template>
   <section class="singleprod-imgs">
      <div class="singleprod-imgs-first">
         <div class="singleprod-imgs-first__item" v-for="image in images" :key="image">
            <img :src="image" alt="single-prod-min">
         </div>

      </div>
      <div class="singleprod-imgs-second">
         <div class="singleprod-imgs-second__item" v-for="image in images" :key="image">
            <img :src="image" alt="single-prod-max">
         </div>
