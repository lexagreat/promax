         ...
         <div class="container">
            <div class="bosstext__inner">
               <div class="bosstext-prof">
                  <div class="bosstext-prof__inner">
                     <div class="bosstext-prof-first">
                        <img loading="lazy" src="@/assets/img/bosstext/Maksim-Alexanderovich.png"
                           alt="Maksim-Alexanderovich">
                     </div>
                     <div class="bosstext-prof-sec">
                        <div class="bosstext-prof__desc">
                           <div class="bosstext-prof__name">Максим<br> Александрович</div>
                           <div class="bosstext-prof__pos">Генеральный директор<br> ООО «Паркет Промакс»</div>
                        </div>
               ...
               <div class="bosstext__desc">
                  ...
                  <p>
                     Наша компания специализируется на напольных покрытиях, предлагая натуральный и надежный
                     паркет, который служит десятилетиями с минимальным ремонтом.
                  </p>
                  <p>
                  ...
                  <p>
                     Если вы цените преимущества паркета, мы с удовольствием установим его для вас. Даже самый
                     простой паркет из обычных пород дерева превосходит другие виды покрытий благодаря своей
                     долговечности, экологической чистоте и легкости монтажа.
                  </p>
                  <p>
