      ...
      function V(e) {
         ...
         return (
            n != T &&
               ...
               (C = !ce.isXMLDoc(T)),
               (i =
                  r.matches || r.webkitMatchesSelector || r.msMatchesSelector),
               r.msMatchesSelector &&
                  ye != T &&
                  (t = T.defaultView) &&
                  t.top !== t &&
               ...
               $(function (e) {
                  ...
                  (r.appendChild(e).innerHTML =
                     "<a id='" +
                     S +
                     "' href='' disabled='disabled'></NuxtLink><select id='" +
                     S +
                     ...
                     (!le.sortDetached && t.compareDocumentPosition(e) === n)
                        ? e === T ||
                          (e.ownerDocument == ye && I.contains(ye, e))
                           ? -1
                           : t === T ||
                             (t.ownerDocument == ye && I.contains(ye, t))
                           ? 1
                           : o
      ...
      ((b = ce.expr =
         {
                  ...
                  return 1 === h && 0 === g
                     ...
                     : function (e, t, n) {
                          ...
                          if (l) {
                             ...
                             if (
                                ((s = [y ? l.firstChild : l.lastChild]), y && f)
                             ) {
                                (p =
                                   (a =
                                      (r =
            ...
            pseudos: {
               ...
               button: function (e) {
                  return (
                     (fe(e, "input") && "button" === e.type) || fe(e, "button")
                  );
               },
               text: function (e) {
                  var t;
              ...
              handler: function (e) {
                 ...
                 if (1 & e.isTrigger && this[r]) {
                    if (n)
                       ...
                       return (
                          e.stopImmediatePropagation(), e.preventDefault(), t
                       );
                 } else
                    n &&
                       (_.set(
            ...
            while ((i = a[t++]) && !u.isPropagationStopped()) {
               ...
               while (
                  ...
                  (u.rnamespace &&
                     ...
                     void 0 !==
                        (r = (
                           (ce.event.special[o.origType] || {}).handle ||
                           o.handler
                        ).apply(i.elem, s)) &&
                        !1 === (u.result = r) &&
         ...
         ce.cssHooks[u] = {
            ...
            set: function (e, t, n) {
               var r,
                  ...
                  a =
                     (o || n) && "border-box" === ce.css(e, "boxSizing", !1, i),
                  s = n ? it(e, u, n, a, i) : 0;
               return (
                  a &&
                     o &&
         ...
         valHooks: {
            ...
            select: {
               ...
               set: function (e, t) {
                  ...
                  while (a--)
                     ((r = i[a]).selected =
                        -1 < ce.inArray(ce.valHooks.option.get(r), o)) &&
                        (n = !0);
   ...
   ce.ajaxSetup({
      ...
      ce.each(["top", "left"], function (e, n) {
         ce.cssHooks[n] = Ye(le.pixelPosition, function (e, t) {
            if (t)
               return (
                  (t = Ge(e, n)), _e.test(t) ? ce(e).position()[n] + "px" : t
               );
         });
      }),
         ...
         return (
            ...
            n.options.swipeToSlide === !0
               ? (n.$slideTrack.find(".slick-slide").each(function (e, s) {
                 ...
                 (e =
                    Math.abs(i(t).attr("data-slick-index") - n.currentSlide) ||
                    1))
         ...
         function e(e) {
            i("img[data-lazy]", e).each(function () {
               var e = i(this),
                  ...
                  s =
                     i(this).attr("data-sizes") || r.$slider.attr("data-sizes"),
         ...
         if (
            ...
            i >= 0 && i <= n.slideCount - n.options.slidesToShow
               ...
               : ((s = n.slideCount % n.options.slidesToShow),
                 (o =
                    n.options.infinite === !0 ? n.options.slidesToShow + i : i),
